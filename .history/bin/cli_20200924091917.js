...
const options = yargs
 .option("stats", { alias: "s", describe: "run stats broken/unique ", type: "boolean", demandOption: false, default: false })
 .option("validate", { alias: "v", describe: "run status check", type: "boolean", demandOption: false, default: false })
 .argv;
